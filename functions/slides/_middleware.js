export async function onRequest(context) {
  ...
  if (request.method === "POST" && url.pathname === "/slides/login") {
    try {
      const formData = await request.formData();
      const password = formData.get("password");
      const to = url.searchParams.get("to") || "/slides/";
  ...
  if (!isAuthenticated && url.pathname !== "/slides/login") {
...
<body>
  ...
  <div class="login-container">
    <div class="login-card">
      ...
      <form action="/slides/login?to=${encodeURIComponent(redirectUrl)}" method="POST">
